...
int main() {
  ...
  DrawDataMC(Data, {Reco}, {"Reco"}, "DatavsReco", false, false, "Pt",
             "#events");
  ...
  TUnfoldDensity* unfold1 = new TUnfoldDensity(
      MigrationMatrix, TUnfold::kHistMapOutputVert, TUnfold::kRegModeNone,
      TUnfold::kEConstraintNone, TUnfoldDensity::kDensityModeBinWidthAndUser, 0,
      0, 0, "*[UOB]");
  unfold1->SetInput(Data);
  unfold1->DoUnfold(0, Data);
  TH1* unfolded1 = unfold1->GetOutput("unfolded1");
  DrawDataMC(unfolded1, {Gen}, {"Gen"}, "UnfoldedvsGen1", false, false, "Pt",
             "#events");
  ...
  DrawDataMC(UnfoldedTotalError1, {Gen}, {"Gen"}, "UnfoldedEvsGen1", false,
             false, "Pt", "#events");
  ...
  TUnfoldDensity* unfold2 = new TUnfoldDensity(
      MigrationMatrix, TUnfold::kHistMapOutputVert, TUnfold::kRegModeSize,
      TUnfold::kEConstraintNone, TUnfoldDensity::kDensityModeBinWidthAndUser, 0,
      0, 0, "*[UOB]");
  ...
  TGraph* lCurve2avg = 0;
  iBest2avg =
      unfold2->ScanTau(nScan, tauMin, tauMax, &scanResult2avg,
                       TUnfoldDensity::kEScanTauRhoAvgSys, 0, 0, &lCurve2avg);
  ...
  DrawDataMC(unfolded2, {Gen}, {"Gen"}, "UnfoldedvsGen2_avgtau", false, false,
             "Pt", "#events");
  ...
  DrawDataMC(UnfoldedTotalError2, {Gen}, {"Gen"}, "UnfoldedEvsGen2_avgtau",
             false, false, "Pt", "#events");
  ...
  TGraph* lCurve2max = 0;
  iBest2max =
      unfold2->ScanTau(nScan, tauMin, tauMax, &scanResult2max,
                       TUnfoldDensity::kEScanTauRhoMax, 0, 0, &lCurve2max);
  std::cout << " Best tau=" << unfold2->GetTau() << "\n";
  ...
  DrawDataMC(unfolded2max, {Gen}, {"Gen"}, "UnfoldedvsGen2_maxtau", false,
             false, "Pt", "#events");
  ...
  DrawDataMC(UnfoldedTotalError2max, {Gen}, {"Gen"}, "UnfoldedEvsGen2_maxtau",
             false, false, "Pt", "#events");
  ...
  TUnfoldDensity* unfold3 = new TUnfoldDensity(
      MigrationMatrix, TUnfold::kHistMapOutputVert, TUnfold::kRegModeDerivative,
      TUnfold::kEConstraintNone, TUnfoldDensity::kDensityModeBinWidthAndUser, 0,
      0, 0, "*[UOB]");
  ...
  TGraph* lCurve3avg = 0;
  iBest3avg =
      unfold3->ScanTau(nScan, tauMin, tauMax, &scanResult3avg,
                       TUnfoldDensity::kEScanTauRhoAvgSys, 0, 0, &lCurve3avg);
  ...
  DrawDataMC(unfolded3, {Gen}, {"Gen"}, "UnfoldedvsGen3_avgtau", false, false,
             "Pt", "#events");
  ...
  DrawDataMC(UnfoldedTotalError3, {Gen}, {"Gen"}, "UnfoldedEvsGen3_avgtau",
             false, false, "Pt", "#events");
  ...
  // tauMax=0;
  iBest3max =
      unfold3->ScanTau(nScan, tauMin, tauMax, &scanResult3max,
                       TUnfoldDensity::kEScanTauRhoMaxSys, 0, 0, &lCurve3max);
  std::cout << " Best tau=" << unfold3->GetTau() << "\n";
  ...
  DrawDataMC(unfolded3max, {Gen}, {"Gen"}, "UnfoldedvsGen3_maxtau", false,
             false, "Pt", "#events");
  ...
  DrawDataMC(UnfoldedTotalError3max, {Gen}, {"Gen"}, "UnfoldedEvsGen3_maxtau",
             false, false, "Pt", "#events");
  ...
  TUnfoldDensity* unfold4 = new TUnfoldDensity(
      MigrationMatrix, TUnfold::kHistMapOutputVert, TUnfold::kRegModeCurvature,
      TUnfold::kEConstraintNone, TUnfoldDensity::kDensityModeBinWidthAndUser, 0,
      0, 0, "*[UOB]");
  ...
  TGraph* lCurve4avg = 0;
  iBest4avg =
      unfold4->ScanTau(nScan, tauMin, tauMax, &scanResult4avg,
                       TUnfoldDensity::kEScanTauRhoAvgSys, 0, 0, &lCurve4avg);
  ...
  DrawDataMC(unfolded4, {Gen}, {"Gen"}, "UnfoldedvsGen4_avgtau", false, false,
             "Pt", "#events");
  ...
  DrawDataMC(UnfoldedTotalError4, {Gen}, {"Gen"}, "UnfoldedEvsGen4_avgtau",
             false, false, "Pt", "#events");
  ...
  tauMax = 0;
  iBest4max =
      unfold4->ScanTau(nScan, tauMin, tauMax, &scanResult4max,
                       TUnfoldDensity::kEScanTauRhoMaxSys, 0, 0, &lCurve4max);
  std::cout << " Best tau=" << unfold4->GetTau() << "\n";
  ...
  DrawDataMC(unfolded4max, {Gen}, {"Gen"}, "UnfoldedvsGen4_maxtau", false,
             false, "Pt", "#events");
  ...
  DrawDataMC(UnfoldedTotalError4max, {Gen}, {"Gen"}, "UnfoldedEvsGen4_maxtau",
             false, false, "Pt", "#events");
